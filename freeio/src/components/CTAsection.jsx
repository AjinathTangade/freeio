...
function CTAsection() {
  return (
    <>
    <section className="overflow-hidden container mx-auto sm:grid sm:grid-cols-2 sm:items-center">
    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto  px-6 lg:px-8 border-b pb-14">
        <h2 className="text-center text-sm font-normal leading-8 text-gray-400">
          Trusted by the world’s most innovative teams
        </h2>
        <div className="mx-auto mt-10 max-w-lg overflow-x-auto flex sm:overflow-x-auto lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <img
